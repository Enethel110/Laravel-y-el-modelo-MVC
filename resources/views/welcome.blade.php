...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Carlos Enethel Mendoza Resendiz</title>
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <h1 style="font-size: 30px; color: white; background-color: rgba(0, 0, 0, 0.603); text-decoration: underline;" class="font-extrabold text-center mt-10 font-serif">
                                Carlos Enethel Mendoza Resendiz
                            </h1>
